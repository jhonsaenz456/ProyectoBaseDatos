...
public class frmVista extends javax.swing.JFrame {
    ...
    public frmVista() {
        ...
        JMenu menu1 = new JMenu("Modulo 1");
         JMenuItem itemEstudiantes = new JMenuItem("Estudiantes");
        menu1.add(itemEstudiantes);
        
        JMenuItem itemCitas = new JMenuItem("Citas");
        menu1.add(itemCitas);

        JMenuItem itemConfirmar = new JMenuItem("Confirmar Citas");
        menu1.add(itemConfirmar);
        
        menuBar.add(menu1);
        
          JMenu menu2 = new JMenu("Modulo 2");
         menuBar.add(menu2);
        JMenu menu3 = new JMenu("Modulo 3");
         menuBar.add(menu3);
        ...
        itemCitas.addActionListener(e -> {
            frmCitas formularioCitas = new frmCitas();
            formularioCitas.setVisible(true);
        });

    

        itemConfirmar.addActionListener(e -> {
            frmConfirmacionCita formularioConfirmar = new frmConfirmacionCita();
            formularioConfirmar.setVisible(true);
        });
    }
    ...
    private void initComponents() {
        ...
        jMenu1.setText("Modulo 1 ");

        jMenuItem1.setText("Datos Estudiante");
        ...
        jMenuItem2.setText("Registro de citas");
        ...
        jMenuItem3.setText("Confirmación de citas ");
